document.getElementById("scholarshipForm").addEventListener("submit", function(e) {
    ...
    isValid &= validateField(
        ...
        val => val !== "",
        "Test Center is required"
    );


    // Date 1
    isValid &= validateField(
        document.querySelector("input[name='date1']"),
        val => val !== "",
        "Date is required"
    );
    ...
    // Date 2
    isValid &= validateField(
        document.querySelector("input[name='date2']"),
        val => val !== "",
        "Date is required"
    );
    ...
    // Time 1
    isValid &= validateField(
        document.querySelector("input[name='time1']"),
        val => val !== "",
        "Time is required"
    );
    ...
    // Time 2
    isValid &= validateField(
        document.querySelector("input[name='time2']"),
        val => val !== "",
        "Time is required"
    );
